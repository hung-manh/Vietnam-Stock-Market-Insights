...
def candlestick_chart_ver1(df, title='Candlestick Chart with MA and Volume', x_label='Date', y_label='Price', ma_periods=None, figure_size=(10, 8), reference_period=None, colors=('#00F4B0', '#FF3747'), reference_colors=('blue', 'black')):
    """
    ...
    if reference_period:
        ...
        fig.add_trace(lowest_low_trace, row=1, col=1)
        fig.add_trace(highest_high_trace, row=1, col=1)
    ...
    fig.update_xaxes(showspikes=True,spikethickness=2,spikedash="dot",spikecolor="rgba(128, 128, 128, 0.5)",spikemode="across",)
    return fig

# def candlestick_chart_ver2(df, title='Candlestick Chart with MA and Volume', x_label='Date', y_label='Price', ma_periods=None, show_volume=True, figure_size=(10, 8), reference_period=None, colors=('#00F4B0', '#FF3747'), reference_colors=('blue', 'black')):
#     """
#     Generate a candlestick chart with optional Moving Averages (MA) lines, volume data, and reference lines.
